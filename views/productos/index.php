    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/reportePdf'; ?>" target="_blank"><i
                                class="fas fa-file-pdf text-danger"></i> Reporte PDF</a>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/reporteExcel'; ?>"><i
                                class="fas fa-file-excel text-success"></i> Reporte Excel</a>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/generarBarcode'; ?>" target="_blank"><i
                                class="fas fa-barcode"></i> Barcode</a>
                    </li>
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'productos/inactivos'; ?>"><i
                                class="fas fa-trash text-warning"></i> Inactivos</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-productos" role="tabpanel"
                aria-labelledby="nav-productos-tab" tabindex="0">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0.01" name="precio_compra"
                                    id="precio_compra" placeholder="Nombre">
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" step="0.01" min="0.01" name="precio_venta"
                                    id="precio_venta" placeholder="Nombre">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_medida" class="form-control" name="id_medida">
                                    ...
                                    <?php foreach ($data['medidas'] as $medida) { ?>
                                        <option value="<?php echo $medida['id']; ?>"><?php echo $medida['medida']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_categoria" class="form-control" name="id_categoria">
                                    ...
                                    <?php foreach ($data['categorias'] as $categoria) { ?>
                                        <option value="<?php echo $categoria['id']; ?>"><?php echo $categoria['categoria']; ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
