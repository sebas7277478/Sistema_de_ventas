            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="ruc" name="ruc" class="form-control"
                            value="<?php echo $data['empresa']['ruc']; ?>" placeholder="Ruc">
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="nombre" name="nombre" class="form-control"
                            value="<?php echo $data['empresa']['nombre']; ?>" placeholder="Nombre">
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="telefono" name="telefono" class="form-control"
                            value="<?php echo $data['empresa']['telefono']; ?>" placeholder="Telefono">
                    </div>
                ...
                <div class="col-lg-4 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="email" id="correo" name="correo" class="form-control"
                            value="<?php echo $data['empresa']['correo']; ?>" placeholder="Correo electrónico">
                    </div>
                ...
                <div class="col-lg-8 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" id="direccion" name="direccion" class="form-control"
                            value="<?php echo $data['empresa']['direccion']; ?>" placeholder="Direccion">
                    </div>
                ...
                <div class="col-lg-3 col-sm-6 mb-2">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" id="impuesto" name="impuesto" class="form-control"
                            value="<?php echo $data['empresa']['impuesto']; ?>" placeholder="Impuesto">
                    </div>
                </div>
                <div class="col-lg-9 col-sm-6 mb-2">
                    <div class="form-group">
                        ...
                        <textarea id="mensaje" class="form-control" name="mensaje" rows="3"
                            placeholder="Mensaje de agradecimiento"><?php echo $data['empresa']['mensaje']; ?></textarea>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    ...
                    <div id="containerPreview">
                        <img class="img-thumbaild" src="<?php echo BASE_URL . 'assets/images/logo-img.png'; ?>" alt="LOGO-IMG_PNG" width="200">
                    </div>
                </div>
            </div>
            <div class="text-end">
