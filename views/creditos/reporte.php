...
<body>
        ...
        <tr>
            ...
            <td class="info-compra">
                <div class="container-factura">
                    <span class="factura"><strong>CREDITO</strong></span>
                    <p>N°: <strong>
    ...
    <table id="container-info">
        <tr>
            <td>
                <strong>
                    <?php echo $data['credito']['documento'] ?>:
                </strong>
                <p>
                    <?php echo $data['credito']['num_documento'] ?>
                </p>
            </td>
            <td>
    ...
    <h5 class="title">Detalles de los Abonos</h5>
    <table id="container-producto">
        <thead>
            <tr>
                <th>Fecha </th>
