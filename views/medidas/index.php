    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'medidas/inactivos'; ?>"><i
        ...
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                <button class="nav-link active" id="nav-usuarios-tab" data-bs-toggle="tab" data-bs-target="#nav-medidas"
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-medidas" role="tabpanel"
                aria-labelledby="nav-medidas-tab" tabindex="0">
