    ...
    <div class="card-body">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button class="nav-link" id="nav-kardex-tab" data-bs-toggle="tab" data-bs-target="#nav-kardex"
                    type="button" role="tab" aria-controls="nav-kardex" aria-selected="false">Kardex</button>
            </div>
        </nav>
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade p-3" id="nav-kardex" role="tabpanel" aria-labelledby="nav-kardex-tab"
                ...
                <span class="text-danger fw-bold" id="errorBusqueda"></span>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="btn-group btn-group-toggle mb-2" data-toggle="buttons">
                    <label class="btn btn-primary">
                        <input type="radio" id="barcodeAjuste" name="radioAjuste" checked><i class="fas fa-barcode"></i>
                        Barcode
                    </label>
                    <label class="btn btn-info">
                ...
                <div>
                    <span class="text-danger fw-bold" id="errorBusquedaAjuste"></span>
                </div>
                <label for="my-input">Ajuste - / +</label>
                <div class="d-flex justify-content-between">
                    <div class="form-group">
                        <input id="cantidadAjuste" class="form-control" type="number" placeholder="Cantidad">
                    </div>
                    <button class="btn btn-primary" type="button" id="btnProcesas">Procesar</button>
                </div>
            </div>
        </div>
    </div>
