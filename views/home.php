		...
		<div class="card radius-10">
			<div class="card-body">
				...
				<div class="d-flex align-items-center ms-auto font-13 gap-2 my-3">
					...
					<span class="border px-1 rounded cursor-pointer"><i class="fas fa-dollar-sign"
							style="color: #85bb65"></i> 
						<?php echo number_format($data['total_productos']['resultado']); ?>
					</span>
				</div>
...
<div class="card radius-10">
	<div class="card-body">
		...
		<div class="dropdown ms-auto">
			...
			<ul class="dropdown-menu">
				<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/recientesPdf'; ?>" target="_blank"><i
							class="fas fa-file-pdf text-danger"></i> Reporte PDF</a>
				</li>
				<li><a class="dropdown-item" href="<?php echo BASE_URL . 'admin/recientesExcel'; ?>"><i
							class="fas fa-file-excel text-success"></i> Reporte Excel</a>
				</li>
			</ul>
		</div>
