...
<body>
    ...
    <div class="datos-info">
        <p><strong><?php echo $data['venta']['documento']; ?></strong>
            <?php echo $data['venta']['num_documento']; ?>
        </p>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-right">
                    <?php echo number_format($data['venta']['descuento'], 2); ?>
                </td>
            </tr>
            <tr>
                <td class="text-right" colspan="3">Total con Descuento</td>
                <td class="text-right">
                    <?php echo number_format($data['venta']['total'] - $data['venta']['descuento'], 2); ?>
                </td>
            </tr>
            <tr>
