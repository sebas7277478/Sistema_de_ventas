    ...
    <div class="card-body">
        <div class="d-flex align-items-center">
            ...
            <div class="dropdown ms-auto">
                ...
                <ul class="dropdown-menu">
                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'proveedor/inactivos'; ?>"><i
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active mt-2" id="nav-proveedores" role="tabpanel"
                aria-labelledby="nav-proveedores-tab" tabindex="0">
                ...
                <form id="formulario" autocomplete="off">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4 mb-3">
                            <label for="num_documento">Ruc <span class="text-danger">*</span></label>
