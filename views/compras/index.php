            ...
            <div class="tab-pane fade show active p-3" id="nav-compras" role="tabpanel"
                ...
                <div class="row justify-content-between">
                    <div class="col-md-4">
                        ...
                        <div>
                            <span class="text-danger fw-bold" id="errorProveedor"></span>
                        </div>
                        ...
                        <ul class="list-group">
                            <li class="list-group-item" id="direccionProveedor"><i class="fas fa-home"></i></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group mb-2">
                            ...
                            <input class="form-control" type="text" id="serie" placeholder="Numero Compra">
                        </div>
                        <div class="d-grid">
