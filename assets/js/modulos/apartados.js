...
const tbnProcesar = document.querySelector('#tbnProcesar');
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    tbnProcesar.addEventListener('click', function () {
        Swal.fire({
    ...
    btnAccion.addEventListener('click', function () {
        const filas = document.querySelectorAll('#tblNuevoApartado tr').length;
        if (filas < 2) {
            ...
            alertaPersonalizada('warning', 'FECHA APARTADO ES REQUERIDA');
            return;
        } else if (fecha_retiro.value == '') {
            alertaPersonalizada('warning', 'LA FECHA RETIRO ES REQUERIDA');
            return;
        } else if (abono.value == '') {
            alertaPersonalizada('warning', 'EL ABONO ES REQUERIDO');
            return;
        } else {
