    ...
    if (this.readyState == 4 && this.status == 200) {
      ...
      myChart = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [{
            label: 'Ventas',
            data: [res.venta.ene, res.venta.feb, res.venta.mar, res.venta.abr, res.venta.may, res.venta.jun, res.venta.jul, res.venta.ago, res.venta.sep, res.venta.oct, res.venta.nov, res.venta.dic],
            ...
            label: 'Compras',
            data: [res.compra.ene, res.compra.feb, res.compra.mar, res.compra.abr, res.compra.may, res.compra.jun, res.compra.jul, res.compra.ago, res.compra.sep, res.compra.oct, res.compra.nov, res.compra.dic],
