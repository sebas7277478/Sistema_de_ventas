...
class Productos extends Controller
{
    ...
    public function listar()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            ...
            $data[$i]['imagen'] = '<img class="img-thumbnail" src="' . BASE_URL . $foto . '" width="60">';
            $data[$i]['acciones'] = '<div>
    ...
    public function listarInactivos()
    {
        ...
        for ($i = 0; $i < count($data); $i++) {
            $data[$i]['imagen'] = '<img class="img-thumbnail" src="' . BASE_URL . $data[$i]['foto'] . '" width="90">';
            $data[$i]['acciones'] = '<div>
    ...
    public function buscarPorNombre()
    {
        ...
        foreach ($data as $row) {
            $result['id'] = $row['id'];
            $result['label'] = $row['descripcion'] . ' ' . $row['categoria'] . ' - Stock - ' . $row['cantidad'] . ' - Precio - ' . $row['precio_venta'];
    ...
    public function reporteExcel()
    {
        ...
        $spreadsheet->getProperties()->setTitle("Listado de Productos");
