...
class Usuarios extends Controller
{
    ...
    public function profile()
    {
        ...
        $data['usuarios'] = $this->model->editar($this->id_usuario);
    ...
    public function modificarDatos()
    {
        ...
        $nuevaClave = strClean($_POST['nuevaClave']);
        ...
        if (empty($nombre)) {
            ...
            if (empty($nuevaClave)) {
                ...
                if (empty($verificarCorreo)) {
                    ...
                    if (empty($verificarTel)) {
                        $data = $this->model->modificarDatos($nombre, $apellido, $correo, $telefono, $direccion, $hash, $destino, $this->id_usuario);
                        if ($data == 1) {
                            if (!empty($name)) {
